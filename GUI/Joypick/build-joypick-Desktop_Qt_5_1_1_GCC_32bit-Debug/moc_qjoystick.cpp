...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QJoystick_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 23, 8)
    ...
    "QJoystick\0setJoystick\0\0jsNumber\0"
};
...
const QMetaObject QJoystick::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QJoystick.data,
      qt_meta_data_QJoystick,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QJoystick.stringdata))
