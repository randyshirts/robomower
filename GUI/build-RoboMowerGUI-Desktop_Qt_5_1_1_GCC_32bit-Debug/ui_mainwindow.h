...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/connect.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionConnect->setIcon(icon1);
        actionDisconnect = new QAction(MainWindow);
        actionDisconnect->setObjectName(QStringLiteral("actionDisconnect"));
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/disconnect.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionDisconnect->setIcon(icon2);
        actionConfigure = new QAction(MainWindow);
        actionConfigure->setObjectName(QStringLiteral("actionConfigure"));
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/settings.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionConfigure->setIcon(icon3);
        actionClear = new QAction(MainWindow);
        actionClear->setObjectName(QStringLiteral("actionClear"));
        QIcon icon4;
        icon4.addFile(QStringLiteral(":/clear.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionClear->setIcon(icon4);
        actionQuit = new QAction(MainWindow);
        actionQuit->setObjectName(QStringLiteral("actionQuit"));
        QIcon icon5;
        icon5.addFile(QStringLiteral(":/application-exit.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionQuit->setIcon(icon5);
        actionTerminal = new QAction(MainWindow);
        actionTerminal->setObjectName(QStringLiteral("actionTerminal"));
        QIcon icon6;
        icon6.addFile(QStringLiteral(":/video-qml-paint-rate.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        menuBar->setGeometry(QRect(0, 0, 425, 20));
        ...
        menuCalls->addAction(actionTerminal);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionTerminal->setIconText(QApplication::translate("MainWindow", "Console", 0));
#ifndef QT_NO_TOOLTIP
        actionTerminal->setToolTip(QApplication::translate("MainWindow", "Opens a console terminal to show all received messages from the serial port", 0));
#endif // QT_NO_TOOLTIP
        actionTerminal->setShortcut(QApplication::translate("MainWindow", "Ctrl+T", 0));
